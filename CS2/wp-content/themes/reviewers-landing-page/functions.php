<?php 
add_action( 'wp_enqueue_scripts', 'reviewers_landing_page_enqueue_styles' );
function reviewers_landing_page_enqueue_styles() {
	wp_enqueue_style( 'reviewers-landing-page', get_template_directory_uri() . '/style.css' ); 
} 



function reviewers_landing_page_load_google_fonts() {
	wp_enqueue_style( 'superb-landingpage-google-fonts', '//fonts.googleapis.com/css?family=Roboto:400,500,700' ); 
}
add_action( 'wp_enqueue_scripts', 'reviewers_landing_page_load_google_fonts' );




function reviewers_landing_page_customize_register( $wp_customize ) {

	$wp_customize->add_section( 'landingpage_blogposts', array(
		'title'      => __('Review Page Template','superb-landingpage'),
		'priority'   => 20,
		'description'=> __('To activate this design please go to a page and activate the Landing Page Template','superb-landingpage'),
		'capability' => 'edit_theme_options',
		) );


	$wp_customize->add_setting( 'blog_section_background_color', array(
		'default'           => '#eee',
		'sanitize_callback' => 'sanitize_hex_color',
		'transport'         => 'postMessage',
		) );
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'blog_section_background_color', array(
		'label'       => __( 'Section Background Color', 'superb-landingpage' ),
		'section'     => 'landingpage_blogposts',
		'settings'    => 'blog_section_background_color',
		) ) );
	$wp_customize->add_setting( 'blog_section_blogposts_background', array(
		'default'           => '#fff',
		'sanitize_callback' => 'sanitize_hex_color',
		'transport'         => 'postMessage',
		) );
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'blog_section_blogposts_background', array(
		'label'       => __( 'Posts Background Color', 'superb-landingpage' ),
		'section'     => 'landingpage_blogposts',
		'settings'    => 'blog_section_blogposts_background',
		) ) );
	$wp_customize->add_setting( 'blog_section_blogposts_byline', array(
		'default'           => '#fab526',
		'sanitize_callback' => 'sanitize_hex_color',
		'transport'         => 'postMessage',
		) );
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'blog_section_blogposts_byline', array(
		'label'       => __( 'Posts Byline Color', 'superb-landingpage' ),
		'section'     => 'landingpage_blogposts',
		'settings'    => 'blog_section_blogposts_byline',
		) ) );
	$wp_customize->add_setting( 'blog_section_blogposts_headline', array(
		'default'           => '#000',
		'sanitize_callback' => 'sanitize_hex_color',
		'transport'         => 'postMessage',
		) );
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'blog_section_blogposts_headline', array(
		'label'       => __( 'Posts Headline Color', 'superb-landingpage' ),
		'section'     => 'landingpage_blogposts',
		'settings'    => 'blog_section_blogposts_headline',
		) ) );
	$wp_customize->add_setting( 'blog_section_blogposts_excerpt', array(
		'default'           => '#949494',
		'sanitize_callback' => 'sanitize_hex_color',
		'transport'         => 'postMessage',
		) );
	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'blog_section_blogposts_excerpt', array(
		'label'       => __( 'Posts Excerpt Color', 'superb-landingpage' ),
		'section'     => 'landingpage_blogposts',
		'settings'    => 'blog_section_blogposts_excerpt',
		) ) );


}
add_action( 'customize_register', 'reviewers_landing_page_customize_register' );



if(! function_exists('reviewers_landing_page_customize_register_output' ) ):
	function reviewers_landing_page_customize_register_output(){
		?>
		...
		.landingpage-post-button-wrapper .landingpage-button { background: <?php echo esc_attr(get_theme_mod( 'lp_button_bg_color')); ?>; }
		.landingpage-post-button-wrapper .landingpage-button { color: <?php echo esc_attr(get_theme_mod( 'lp_button_text_color')); ?>; }
		...
		<?php }
		add_action( 'wp_head', 'reviewers_landing_page_customize_register_output' );
		endif;
